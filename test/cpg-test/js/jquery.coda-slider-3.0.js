	...
	var Slider = {
		...
		addArrows: function(){
			...
			if(self.options.dynamicArrowsGraphical){
				$(self.sliderId).before('<div class="coda-nav-left-arrow" data-dir="prev" ><a href="#"><span></span></a></div>');
				$(self.sliderId).after('<div class="coda-nav-right-arrow" data-dir="next" ><a href="#"><span></span></a></div>');
			}
			else{
				$(self.sliderId).before('<div class="coda-nav-left" data-dir="prev" ><a href="#"><span></span></a></div>');
				$(self.sliderId).after('<div class="coda-nav-right" data-dir="next"><a href="#"><span></span></a></div>');
			}
		},
